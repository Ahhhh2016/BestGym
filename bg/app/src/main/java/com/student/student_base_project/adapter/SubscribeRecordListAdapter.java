...
public class SubscribeRecordListAdapter extends BaseQuickAdapter<SubscribeBean, BaseViewHolder> {
    public SubscribeRecordListAdapter(@Nullable List<SubscribeBean> data) {
    ...
    protected void convert(BaseViewHolder helper, SubscribeBean item) {
        ...
        .setText(R.id.tv_desc,item.getTime()).addOnClickListener(R.id.tv_go_detail).addOnClickListener(R.id.tv_del);
