...
import com.student.student_base_project.bean.WheelViewDataBean;
...
//        wl.y = activity.getWindowManager().getDefaultDisplay().getHeight();
     ...
     * 屏幕中间显示删除 查看
     */
    public static Dialog showPopuwindow(Activity activity, int layoutId) {
        View view = LayoutInflater.from(activity).inflate(layoutId, null);
        ...
        TextView tvCheck = dialog.findViewById(R.id.tv_check);
        TextView tvDelete2 = dialog.findViewById(R.id.tv_delete2); //删除
        return dialog;
    }
     ...
     * @return
     */
    public Dialog showWheelViewDialog(Activity activity, List<WheelViewDataBean> mOptionsItems) {
