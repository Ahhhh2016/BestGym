...
<!--  >-->
    <ul class="navbar-nav">
      <li class="nav-item">
        <sidenav-collapse
          url="/manager/sale-manage"
          :aria-controls="''"
          v-bind:collapse="true"
          collapseRef="/manager/sale-manage"
          navText="Income"
        >
      ...
      <li class="nav-item">
        <sidenav-collapse
            url="/manager/order-manage"
            :aria-controls="''"
            v-bind:collapse="true"
            collapseRef="/manager/order-manage"
            navText="Orders"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-collapse
            url="/manager/user-manage"
            :aria-controls="''"
            v-bind:collapse="true"
            collapseRef="/manager/user-manage"
            navText="User"
        >
          <template v-slot:icon>
