...
<!--      </div>-->
      <div class="md-layout">
        <div class="md-layout-item md-size-90 mx-auto md-small-size-100">
          <md-card>
            <carousel
              :per-page="1"
              loop
...
export default {
  ...
  data() {
    return {
      ...
      carousel1: require("@/assets/img/img2.png"),
      carousel2: require("@/assets/img/img1.png"),
      carousel3: require("@/assets/img/img4.png")
    };
  },
  methods: {
    classicModalHide() {
